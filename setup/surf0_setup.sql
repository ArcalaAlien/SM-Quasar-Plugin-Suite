...
REPLACE srv_surf0_ WITH srv_surf0_<subdomain>_ !!!!
[srv1].example.com THE BOXED IN AREA IS THE SUBDOMAIN! 
ALSO CHANGE THE VIEW NAMES AT THE BOTTOM FROM [surf0 Player Info]
...
-- -----------------------------------------------------
-- Table `quasar`.`srv_surf0_players`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quasar`.`srv_surf0_players` ;

CREATE TABLE IF NOT EXISTS `quasar`.`srv_surf0_players` (
...
-- -----------------------------------------------------
-- Table `quasar`.`srv_surf0_maps`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quasar`.`srv_surf0_maps` ;

CREATE TABLE IF NOT EXISTS `quasar`.`srv_surf0_maps` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `quasar`.`srv_surf0_playersmaps`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quasar`.`srv_surf0_playersmaps` ;

CREATE TABLE IF NOT EXISTS `quasar`.`srv_surf0_playersmaps` (
  ...
  CONSTRAINT `FK_playersmaps_players`
    ...
    REFERENCES `quasar`.`srv_surf0_players` (`steam64_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK_playersmaps_maps`
    FOREIGN KEY (`map`)
    REFERENCES `quasar`.`srv_surf0_maps` (`map`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `quasar`.`srv_surf0_votelogs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quasar`.`srv_surf0_votelogs` ;

CREATE TABLE IF NOT EXISTS `quasar`.`srv_surf0_votelogs` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `quasar`.`srv_surf0_chatlogs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quasar`.`srv_surf0_chatlogs` ;

CREATE TABLE IF NOT EXISTS `quasar`.`srv_surf0_chatlogs` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `quasar`.`srv_surf0_mapsfeedback`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quasar`.`srv_surf0_mapsfeedback` ;

CREATE TABLE IF NOT EXISTS `quasar`.`srv_surf0_mapsfeedback` (
  `steam_id` VARCHAR(64) NOT NULL,
  `map` VARCHAR(128) NOT NULL,
  `pos_x` DECIMAL NULL,
  `pos_y` DECIMAL NULL,
...
-- -----------------------------------------------------
-- Placeholder table for view `quasar`.`[surf0 Map Ratings]`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quasar`.`[surf0 Map Ratings]` (`map` INT, `total_votes` INT, `rating` INT);

-- -----------------------------------------------------
-- Placeholder table for view `quasar`.`[surf0 Player Info]`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quasar`.`[surf0 Player Info]` (`name` INT, `steam2_id` INT, `steam3_id` INT, `steam64_id` INT, `points` INT, `credits` INT, `num_loadouts` INT, `equipped_loadout` INT, `first_login` INT, `last_login` INT, `playtime` INT, `time_afk` INT);

-- -----------------------------------------------------
-- View `quasar`.`[surf0 Map Ratings]`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quasar`.`[surf0 Map Ratings]`;
DROP VIEW IF EXISTS `quasar`.`[surf0 Map Ratings]` ;
USE `quasar`;
CREATE  OR REPLACE VIEW `[surf0 Map Ratings]` AS
...
FROM (
    ...
    FROM srv_surf0_maps m
		JOIN srv_surf0_playersmaps pm
			ON m.map = pm.map
	GROUP BY map
) AS vt
	JOIN srv_surf0_playersmaps pm
...
-- -----------------------------------------------------
-- View `quasar`.`[surf0 Player Info]`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quasar`.`[surf0 Player Info]`;
DROP VIEW IF EXISTS `quasar`.`[surf0 Player Info]` ;
USE `quasar`;
CREATE  OR REPLACE VIEW `[surf0 Player Info]` AS
...
USE `quasar`$$
DROP TRIGGER IF EXISTS `quasar`.`srv_surf0_players_AFTER_INSERT` $$
USE `quasar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `quasar`.`srv_surf0_players_AFTER_INSERT` AFTER INSERT ON `srv_surf0_players` FOR EACH ROW
BEGIN
